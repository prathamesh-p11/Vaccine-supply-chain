  ...
  export class BlockchainClient {
    async connectToNetwork() {
      ...
      try {
        ...
        const contract = await network.getContract('blockchainbean3');
    ...
    async submitTesting(args: any) {
      console.log('args in the blockchain client')
      console.log(args)

      let response = await args.contract.submitTransaction(args.function,
        args.tester, args.antibody, args.antigen, args.sideEffects,
    ...
    async submitPackingList(args: any) {
      ...
      let response = await args.contract.submitTransaction(args.function,
        args.company, args.trader, args.PL_Invoice_no, args.PL_IssueDate,
    ...
    async submitWeightTally(args: any) {
      ...
      let response = await args.contract.submitTransaction(args.function,
        ...
        args.chemicalActivity, args.batchId, args.transactionId, args.timestamp
      );
    ...
    async addVaccine(args: any) {
      console.log('args in the blockchain client,addVaccine')
      console.log(args)

      let response = await args.contract.submitTransaction(args.function,
        args.size, args.batchState, args.company,
        args.transactionId, args.timestamp
      );
    ...
    async getVaccine(args: any) {
      console.log('args in the blockchain client,addvaccine')
      console.log(args)


      let response = await args.contract.submitTransaction(args.function,
        args.VaccineID, args.batchId, args.transactionId
      );
